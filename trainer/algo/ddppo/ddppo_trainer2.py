...
from trainer.policy.resnet.resnet_policy import PointNavResNetPolicy_ns
...
def log_time(prev_time, log):
    ...
    return time.time()
@baseline_registry.register_trainer(name="custom_ddppo2")
class DDPPOTrainer2(PPOTrainer):
    ...
    def _setup_actor_critic_agent(self, ppo_cfg: Config) -> None:
        ...
        self.actor_critic = PointNavResNetPolicy_ns(
    ...
    def train(self) -> None:
        ...
        if torch.cuda.is_available():
            ...
            self.device = torch.device("cuda", self.config.GPU_ID)
